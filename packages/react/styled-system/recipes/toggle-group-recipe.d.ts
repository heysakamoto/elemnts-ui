...
export type ToggleGroupRecipeVariantProps = {
  [key in keyof ToggleGroupRecipeVariant]?: ToggleGroupRecipeVariant[key] | undefined
}

export interface ToggleGroupRecipeRecipe {
  __slot: ToggleGroupRecipeSlot
  __type: ToggleGroupRecipeVariantProps
  (props?: ToggleGroupRecipeVariantProps): Pretty<Record<ToggleGroupRecipeSlot, string>>
  ...
  splitVariantProps<Props extends ToggleGroupRecipeVariantProps>(props: Props): [ToggleGroupRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof ToggleGroupRecipeVariantProps>>]
  getVariantProps: (props?: ToggleGroupRecipeVariantProps) => ToggleGroupRecipeVariantProps
}
