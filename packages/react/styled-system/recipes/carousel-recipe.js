...
const carouselRecipeSlotNames = [
	...
	["autoplayTrigger", "carousel__autoplayTrigger"],
	["autoplayIndicator", "carousel__autoplayIndicator"],
	["progressText", "carousel__progressText"],
];
const carouselRecipeSlotFns = /* @__PURE__ */ carouselRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			carouselRecipeDefaultVariants,
			getSlotCompoundVariant(carouselRecipeCompoundVariants, slotName),
		),
	],
);
...
const carouselRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		carouselRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
