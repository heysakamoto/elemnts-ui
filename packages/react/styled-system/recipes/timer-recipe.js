...
const timerRecipeSlotNames = [
	...
	["area", "timer__area"],
	["item", "timer__item"],
	["itemLabel", "timer__itemLabel"],
	["itemGroup", "timer__itemGroup"],
	["separator", "timer__separator"],
	["actionTrigger", "timer__actionTrigger"],
];
const timerRecipeSlotFns = /* @__PURE__ */ timerRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			timerRecipeDefaultVariants,
			getSlotCompoundVariant(timerRecipeCompoundVariants, slotName),
		),
	],
);
...
const timerRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		timerRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
