...
export type SwatchRecipeVariantProps = {
	[key in keyof SwatchRecipeVariant]?:
		| ConditionalValue<SwatchRecipeVariant[key]>
		| undefined;
};
...
export interface SwatchRecipeRecipe {
	...
	splitVariantProps<Props extends SwatchRecipeVariantProps>(
		props: Props,
	): [
		SwatchRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof SwatchRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: SwatchRecipeVariantProps,
	) => SwatchRecipeVariantProps;
}
