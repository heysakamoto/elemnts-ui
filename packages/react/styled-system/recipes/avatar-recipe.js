...
const avatarRecipeFn = memo((props = {}) => {
  return Object.fromEntries(avatarRecipeSlotFns.map(([slotName, slotFn]) => [slotName, slotFn.recipeFn(props)]))
})
...
const getVariantProps = (variants) => ({ ...avatarRecipeDefaultVariants, ...compact(variants) })
