...
export type ItemRecipeVariantProps = {
	[key in keyof ItemRecipeVariant]?:
		| ConditionalValue<ItemRecipeVariant[key]>
		| undefined;
};
...
export interface ItemRecipeRecipe {
	...
	splitVariantProps<Props extends ItemRecipeVariantProps>(
		props: Props,
	): [
		ItemRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof ItemRecipeVariantProps>>,
	];
