...
export type CodeRecipeVariantProps = {
  [key in keyof CodeRecipeVariant]?: ConditionalValue<CodeRecipeVariant[key]> | undefined
}
...
export interface CodeRecipeRecipe {
  ...
  splitVariantProps<Props extends CodeRecipeVariantProps>(props: Props): [CodeRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof CodeRecipeVariantProps>>]
