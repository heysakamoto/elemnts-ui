...
const scrollAreaRecipeSlotFns = /* @__PURE__ */ scrollAreaRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			scrollAreaRecipeDefaultVariants,
			getSlotCompoundVariant(scrollAreaRecipeCompoundVariants, slotName),
		),
	],
);
...
const scrollAreaRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		scrollAreaRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
const scrollAreaRecipeVariantKeys = ["variant", "size"];
const getVariantProps = (variants) => ({
	...scrollAreaRecipeDefaultVariants,
	...compact(variants),
});

export const scrollAreaRecipe = /* @__PURE__ */ Object.assign(
	scrollAreaRecipeFn,
	{
		__recipe__: false,
