...
const collapsibleRecipeSlotFns = /* @__PURE__ */ collapsibleRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			collapsibleRecipeDefaultVariants,
			getSlotCompoundVariant(collapsibleRecipeCompoundVariants, slotName),
		),
	],
);
...
const collapsibleRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		collapsibleRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
export const collapsibleRecipe = /* @__PURE__ */ Object.assign(
	collapsibleRecipeFn,
	{
		__recipe__: false,
