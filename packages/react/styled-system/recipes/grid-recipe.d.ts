...
export type GridRecipeVariantProps = {
  [key in keyof GridRecipeVariant]?: ConditionalValue<GridRecipeVariant[key]> | undefined
}
...
export interface GridRecipeRecipe {
  ...
  splitVariantProps<Props extends GridRecipeVariantProps>(props: Props): [GridRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof GridRecipeVariantProps>>]
