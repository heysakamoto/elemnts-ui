...
export type TextareaRecipeVariantProps = {
	[key in keyof TextareaRecipeVariant]?:
		| ConditionalValue<TextareaRecipeVariant[key]>
		| undefined;
};
...
export interface TextareaRecipeRecipe {
	...
	splitVariantProps<Props extends TextareaRecipeVariantProps>(
		props: Props,
	): [
		TextareaRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof TextareaRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: TextareaRecipeVariantProps,
	) => TextareaRecipeVariantProps;
}
