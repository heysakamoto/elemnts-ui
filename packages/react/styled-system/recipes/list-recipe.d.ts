...
export type ListRecipeVariantProps = {
  [key in keyof ListRecipeVariant]?: ConditionalValue<ListRecipeVariant[key]> | undefined
}
...
export interface ListRecipeRecipe {
  ...
  splitVariantProps<Props extends ListRecipeVariantProps>(props: Props): [ListRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof ListRecipeVariantProps>>]
