...
export type CollapsibleRecipeVariantProps = {
	[key in keyof CollapsibleRecipeVariant]?:
		| ConditionalValue<CollapsibleRecipeVariant[key]>
		| undefined;
};
...
export interface CollapsibleRecipeRecipe {
	...
	(
		props?: CollapsibleRecipeVariantProps,
	): Pretty<Record<CollapsibleRecipeSlot, string>>;
	...
	splitVariantProps<Props extends CollapsibleRecipeVariantProps>(
		props: Props,
	): [
		CollapsibleRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof CollapsibleRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: CollapsibleRecipeVariantProps,
	) => CollapsibleRecipeVariantProps;
