...
export type RadiomarkRecipeVariantProps = {
	[key in keyof RadiomarkRecipeVariant]?:
		| ConditionalValue<RadiomarkRecipeVariant[key]>
		| undefined;
};
...
export interface RadiomarkRecipeRecipe {
	...
	splitVariantProps<Props extends RadiomarkRecipeVariantProps>(
		props: Props,
	): [
		RadiomarkRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof RadiomarkRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: RadiomarkRecipeVariantProps,
	) => RadiomarkRecipeVariantProps;
}
