...
export type StatusRecipeVariantProps = {
  [key in keyof StatusRecipeVariant]?: ConditionalValue<StatusRecipeVariant[key]> | undefined
}
...
export interface StatusRecipeRecipe {
  ...
  splitVariantProps<Props extends StatusRecipeVariantProps>(props: Props): [StatusRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof StatusRecipeVariantProps>>]
  getVariantProps: (props?: StatusRecipeVariantProps) => StatusRecipeVariantProps
}
