...
export type ToggleRecipeVariantProps = {
  [key in keyof ToggleRecipeVariant]?: ConditionalValue<ToggleRecipeVariant[key]> | undefined
}
...
export interface ToggleRecipeRecipe {
  ...
  splitVariantProps<Props extends ToggleRecipeVariantProps>(props: Props): [ToggleRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof ToggleRecipeVariantProps>>]
  getVariantProps: (props?: ToggleRecipeVariantProps) => ToggleRecipeVariantProps
}
