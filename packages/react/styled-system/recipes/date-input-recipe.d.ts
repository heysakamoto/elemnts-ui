...
export type DateInputRecipeVariantProps = {
	[key in keyof DateInputRecipeVariant]?:
		| ConditionalValue<DateInputRecipeVariant[key]>
		| undefined;
};
...
export interface DateInputRecipeRecipe {
	...
	(
		props?: DateInputRecipeVariantProps,
	): Pretty<Record<DateInputRecipeSlot, string>>;
	...
	splitVariantProps<Props extends DateInputRecipeVariantProps>(
		props: Props,
	): [
		DateInputRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof DateInputRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: DateInputRecipeVariantProps,
	) => DateInputRecipeVariantProps;
