...
export type ToastRecipeVariantProps = {
	[key in keyof ToastRecipeVariant]?:
		| ConditionalValue<ToastRecipeVariant[key]>
		| undefined;
};
...
export interface ToastRecipeRecipe {
	...
	splitVariantProps<Props extends ToastRecipeVariantProps>(
		props: Props,
	): [
		ToastRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof ToastRecipeVariantProps>>,
	];
