...
export type InputRecipeVariantProps = {
	[key in keyof InputRecipeVariant]?:
		| ConditionalValue<InputRecipeVariant[key]>
		| undefined;
};
...
export interface InputRecipeRecipe {
	...
	splitVariantProps<Props extends InputRecipeVariantProps>(
		props: Props,
	): [
		InputRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof InputRecipeVariantProps>>,
	];
