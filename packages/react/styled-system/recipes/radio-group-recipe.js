...
const radioGroupRecipeSlotFns = /* @__PURE__ */ radioGroupRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			radioGroupRecipeDefaultVariants,
			getSlotCompoundVariant(radioGroupRecipeCompoundVariants, slotName),
		),
	],
);
...
const radioGroupRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		radioGroupRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
const radioGroupRecipeVariantKeys = ["size"];
const getVariantProps = (variants) => ({
	...radioGroupRecipeDefaultVariants,
	...compact(variants),
});

export const radioGroupRecipe = /* @__PURE__ */ Object.assign(
	radioGroupRecipeFn,
	{
		__recipe__: false,
