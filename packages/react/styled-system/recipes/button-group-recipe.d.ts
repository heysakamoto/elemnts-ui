...
export type ButtonGroupRecipeVariantProps = {
	[key in keyof ButtonGroupRecipeVariant]?:
		| ButtonGroupRecipeVariant[key]
		| undefined;
};
...
export interface ButtonGroupRecipeRecipe {
	...
	(
		props?: ButtonGroupRecipeVariantProps,
	): Pretty<Record<ButtonGroupRecipeSlot, string>>;
	...
	splitVariantProps<Props extends ButtonGroupRecipeVariantProps>(
		props: Props,
	): [
		ButtonGroupRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof ButtonGroupRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: ButtonGroupRecipeVariantProps,
	) => ButtonGroupRecipeVariantProps;
