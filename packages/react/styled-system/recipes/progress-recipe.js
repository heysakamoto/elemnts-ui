...
const progressRecipeSlotFns = /* @__PURE__ */ progressRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			progressRecipeDefaultVariants,
			getSlotCompoundVariant(progressRecipeCompoundVariants, slotName),
		),
	],
);
...
const progressRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		progressRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
const progressRecipeVariantKeys = ["size", "thickness"];
