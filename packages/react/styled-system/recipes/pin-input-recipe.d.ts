...
export type PinInputRecipeVariantProps = {
	[key in keyof PinInputRecipeVariant]?:
		| ConditionalValue<PinInputRecipeVariant[key]>
		| undefined;
};
...
export interface PinInputRecipeRecipe {
	...
	(
		props?: PinInputRecipeVariantProps,
	): Pretty<Record<PinInputRecipeSlot, string>>;
	...
	splitVariantProps<Props extends PinInputRecipeVariantProps>(
		props: Props,
	): [
		PinInputRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof PinInputRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: PinInputRecipeVariantProps,
	) => PinInputRecipeVariantProps;
