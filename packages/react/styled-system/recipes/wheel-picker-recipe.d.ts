...
export type WheelPickerRecipeVariantProps = {
	[key in keyof WheelPickerRecipeVariant]?:
		| ConditionalValue<WheelPickerRecipeVariant[key]>
		| undefined;
};
...
export interface WheelPickerRecipeRecipe {
	...
	(
		props?: WheelPickerRecipeVariantProps,
	): Pretty<Record<WheelPickerRecipeSlot, string>>;
	...
	splitVariantProps<Props extends WheelPickerRecipeVariantProps>(
		props: Props,
	): [
		WheelPickerRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof WheelPickerRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: WheelPickerRecipeVariantProps,
	) => WheelPickerRecipeVariantProps;
