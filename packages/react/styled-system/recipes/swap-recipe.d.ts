...
export type SwapRecipeVariantProps = {
  [key in keyof SwapRecipeVariant]?: ConditionalValue<SwapRecipeVariant[key]> | undefined
}
...
export interface SwapRecipeRecipe {
  ...
  splitVariantProps<Props extends SwapRecipeVariantProps>(props: Props): [SwapRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof SwapRecipeVariantProps>>]
