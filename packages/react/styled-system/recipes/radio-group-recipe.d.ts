...
export type RadioGroupRecipeVariantProps = {
	[key in keyof RadioGroupRecipeVariant]?:
		| ConditionalValue<RadioGroupRecipeVariant[key]>
		| undefined;
};
...
export interface RadioGroupRecipeRecipe {
	...
	(
		props?: RadioGroupRecipeVariantProps,
	): Pretty<Record<RadioGroupRecipeSlot, string>>;
	...
	splitVariantProps<Props extends RadioGroupRecipeVariantProps>(
		props: Props,
	): [
		RadioGroupRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof RadioGroupRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: RadioGroupRecipeVariantProps,
	) => RadioGroupRecipeVariantProps;
