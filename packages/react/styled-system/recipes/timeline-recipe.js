...
const timelineRecipeSlotFns = /* @__PURE__ */ timelineRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			timelineRecipeDefaultVariants,
			getSlotCompoundVariant(timelineRecipeCompoundVariants, slotName),
		),
	],
);
...
const timelineRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		timelineRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
const timelineRecipeVariantKeys = ["hideLastSeparator"];
