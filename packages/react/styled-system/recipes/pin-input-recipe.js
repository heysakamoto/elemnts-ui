...
const pinInputRecipeSlotFns = /* @__PURE__ */ pinInputRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			pinInputRecipeDefaultVariants,
			getSlotCompoundVariant(pinInputRecipeCompoundVariants, slotName),
		),
	],
);
...
const pinInputRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		pinInputRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
