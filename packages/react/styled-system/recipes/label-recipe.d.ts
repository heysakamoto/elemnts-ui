...
export type LabelRecipeVariantProps = {
	[key in keyof LabelRecipeVariant]?:
		| ConditionalValue<LabelRecipeVariant[key]>
		| undefined;
};
...
export interface LabelRecipeRecipe {
	...
	splitVariantProps<Props extends LabelRecipeVariantProps>(
		props: Props,
	): [
		LabelRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof LabelRecipeVariantProps>>,
	];
