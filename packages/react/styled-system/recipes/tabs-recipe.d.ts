...
type TabsRecipeSlot = "root" | "content" | "list" | "trigger" | "indicator" | "panel"

export type TabsRecipeVariantProps = {
  [key in keyof TabsRecipeVariant]?: ConditionalValue<TabsRecipeVariant[key]> | undefined
}
...
export interface TabsRecipeRecipe {
  ...
  splitVariantProps<Props extends TabsRecipeVariantProps>(props: Props): [TabsRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof TabsRecipeVariantProps>>]
