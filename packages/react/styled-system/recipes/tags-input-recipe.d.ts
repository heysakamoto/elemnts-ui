...
export type TagsInputRecipeVariantProps = {
	[key in keyof TagsInputRecipeVariant]?:
		| ConditionalValue<TagsInputRecipeVariant[key]>
		| undefined;
};
...
export interface TagsInputRecipeRecipe {
	...
	(
		props?: TagsInputRecipeVariantProps,
	): Pretty<Record<TagsInputRecipeSlot, string>>;
	...
	splitVariantProps<Props extends TagsInputRecipeVariantProps>(
		props: Props,
	): [
		TagsInputRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof TagsInputRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: TagsInputRecipeVariantProps,
	) => TagsInputRecipeVariantProps;
