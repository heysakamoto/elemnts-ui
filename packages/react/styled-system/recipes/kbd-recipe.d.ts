...
export type KbdRecipeVariantProps = {
	[key in keyof KbdRecipeVariant]?:
		| ConditionalValue<KbdRecipeVariant[key]>
		| undefined;
};
...
export interface KbdRecipeRecipe {
	...
	splitVariantProps<Props extends KbdRecipeVariantProps>(
		props: Props,
	): [
		KbdRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof KbdRecipeVariantProps>>,
	];
