...
export type InputGroupRecipeVariantProps = {
  [key in keyof InputGroupRecipeVariant]?: ConditionalValue<InputGroupRecipeVariant[key]> | undefined
}

export interface InputGroupRecipeRecipe {
  __slot: InputGroupRecipeSlot
  __type: InputGroupRecipeVariantProps
  (props?: InputGroupRecipeVariantProps): Pretty<Record<InputGroupRecipeSlot, string>>
  ...
  getVariantProps: (props?: InputGroupRecipeVariantProps) => InputGroupRecipeVariantProps
}
