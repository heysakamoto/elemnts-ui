...
export type CheckmarkRecipeVariantProps = {
	[key in keyof CheckmarkRecipeVariant]?:
		| ConditionalValue<CheckmarkRecipeVariant[key]>
		| undefined;
};
...
export interface CheckmarkRecipeRecipe {
	...
	splitVariantProps<Props extends CheckmarkRecipeVariantProps>(
		props: Props,
	): [
		CheckmarkRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof CheckmarkRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: CheckmarkRecipeVariantProps,
	) => CheckmarkRecipeVariantProps;
}
