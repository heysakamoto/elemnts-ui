...
const menuRecipeSlotNames = [
	...
	["itemIndicator", "menu__itemIndicator"],
	...
	["radioItemGroup", "menu__radioItemGroup"],
	["radioItem", "menu__radioItem"],
	["checkboxItem", "menu__checkboxItem"],
];
const menuRecipeSlotFns = /* @__PURE__ */ menuRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			menuRecipeDefaultVariants,
			getSlotCompoundVariant(menuRecipeCompoundVariants, slotName),
		),
	],
);
...
const menuRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		menuRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
