...
export type ImageRecipeVariantProps = {
  [key in keyof ImageRecipeVariant]?: ConditionalValue<ImageRecipeVariant[key]> | undefined
}
...
export interface ImageRecipeRecipe {
  ...
  splitVariantProps<Props extends ImageRecipeVariantProps>(props: Props): [ImageRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof ImageRecipeVariantProps>>]
