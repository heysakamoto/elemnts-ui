...
export type AccordionRecipeVariantProps = {
	[key in keyof AccordionRecipeVariant]?:
		| ConditionalValue<AccordionRecipeVariant[key]>
		| undefined;
};
...
export interface AccordionRecipeRecipe {
	...
	(
		props?: AccordionRecipeVariantProps,
	): Pretty<Record<AccordionRecipeSlot, string>>;
	...
	splitVariantProps<Props extends AccordionRecipeVariantProps>(
		props: Props,
	): [
		AccordionRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof AccordionRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: AccordionRecipeVariantProps,
	) => AccordionRecipeVariantProps;
