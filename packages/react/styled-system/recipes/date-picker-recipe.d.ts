...
type DatePickerRecipeSlot = "root" | "trigger" | "content" | "control" | "label" | "positioner" | "input" | "clearTrigger" | "table" | "nextTrigger" | "prevTrigger" | "view" | "monthSelect" | "rangeText" | "tableBody" | "tableCell" | "tableCellTrigger" | "tableHead" | "tableHeader" | "tableRow" | "viewTrigger" | "viewControl" | "yearSelect" | "presetTrigger"
...
export interface DatePickerRecipeRecipe {
  ...
  (props?: DatePickerRecipeVariantProps): Pretty<Record<DatePickerRecipeSlot, string>>
  ...
  getVariantProps: (props?: DatePickerRecipeVariantProps) => DatePickerRecipeVariantProps
}
