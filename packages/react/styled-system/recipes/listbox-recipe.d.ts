...
export type ListboxRecipeVariantProps = {
	[key in keyof ListboxRecipeVariant]?:
		| ConditionalValue<ListboxRecipeVariant[key]>
		| undefined;
};
...
export interface ListboxRecipeRecipe {
	...
	(
		props?: ListboxRecipeVariantProps,
	): Pretty<Record<ListboxRecipeSlot, string>>;
	...
	splitVariantProps<Props extends ListboxRecipeVariantProps>(
		props: Props,
	): [
		ListboxRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof ListboxRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: ListboxRecipeVariantProps,
	) => ListboxRecipeVariantProps;
