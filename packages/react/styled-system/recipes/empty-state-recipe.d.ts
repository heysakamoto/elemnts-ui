...
export type EmptyStateRecipeVariantProps = {
	[key in keyof EmptyStateRecipeVariant]?:
		| ConditionalValue<EmptyStateRecipeVariant[key]>
		| undefined;
};
...
export interface EmptyStateRecipeRecipe {
	...
	(
		props?: EmptyStateRecipeVariantProps,
	): Pretty<Record<EmptyStateRecipeSlot, string>>;
	...
	splitVariantProps<Props extends EmptyStateRecipeVariantProps>(
		props: Props,
	): [
		EmptyStateRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof EmptyStateRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: EmptyStateRecipeVariantProps,
	) => EmptyStateRecipeVariantProps;
