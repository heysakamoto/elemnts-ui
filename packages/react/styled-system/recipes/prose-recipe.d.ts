...
export type ProseRecipeVariantProps = {
	[key in keyof ProseRecipeVariant]?:
		| ConditionalValue<ProseRecipeVariant[key]>
		| undefined;
};
...
export interface ProseRecipeRecipe {
	...
	splitVariantProps<Props extends ProseRecipeVariantProps>(
		props: Props,
	): [
		ProseRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof ProseRecipeVariantProps>>,
	];
