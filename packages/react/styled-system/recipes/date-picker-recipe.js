...
const datePickerRecipeSlotNames = [
	...
	["clearTrigger", "date-picker__clearTrigger"],
	["table", "date-picker__table"],
	["nextTrigger", "date-picker__nextTrigger"],
	["prevTrigger", "date-picker__prevTrigger"],
	["view", "date-picker__view"],
	["monthSelect", "date-picker__monthSelect"],
	["rangeText", "date-picker__rangeText"],
	["tableBody", "date-picker__tableBody"],
	["tableCell", "date-picker__tableCell"],
	["tableCellTrigger", "date-picker__tableCellTrigger"],
	["tableHead", "date-picker__tableHead"],
	["tableHeader", "date-picker__tableHeader"],
	["tableRow", "date-picker__tableRow"],
	["viewTrigger", "date-picker__viewTrigger"],
	["viewControl", "date-picker__viewControl"],
	["yearSelect", "date-picker__yearSelect"],
	["presetTrigger", "date-picker__presetTrigger"],
];
...
const datePickerRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		datePickerRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
export const datePickerRecipe = /* @__PURE__ */ Object.assign(
	datePickerRecipeFn,
	{
		__recipe__: false,
