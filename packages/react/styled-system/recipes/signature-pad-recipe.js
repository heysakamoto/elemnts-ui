...
const signaturePadRecipeSlotNames = [
	...
	["clearTrigger", "signature-pad__clearTrigger"],
	["segment", "signature-pad__segment"],
	["segmentPath", "signature-pad__segmentPath"],
	["guide", "signature-pad__guide"],
];
const signaturePadRecipeSlotFns =
	/* @__PURE__ */ signaturePadRecipeSlotNames.map(([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			signaturePadRecipeDefaultVariants,
			getSlotCompoundVariant(signaturePadRecipeCompoundVariants, slotName),
		),
	]);

const signaturePadRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		signaturePadRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
export const signaturePadRecipe = /* @__PURE__ */ Object.assign(
	signaturePadRecipeFn,
	{
		__recipe__: false,
