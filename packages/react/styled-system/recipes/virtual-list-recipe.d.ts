...
interface VirtualListRecipeVariant {
...
export type VirtualListRecipeVariantProps = {
  [key in keyof VirtualListRecipeVariant]?: ConditionalValue<VirtualListRecipeVariant[key]> | undefined
}

export interface VirtualListRecipeRecipe {
  __slot: VirtualListRecipeSlot
  __type: VirtualListRecipeVariantProps
  (props?: VirtualListRecipeVariantProps): Pretty<Record<VirtualListRecipeSlot, string>>
  ...
  splitVariantProps<Props extends VirtualListRecipeVariantProps>(props: Props): [VirtualListRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof VirtualListRecipeVariantProps>>]
  getVariantProps: (props?: VirtualListRecipeVariantProps) => VirtualListRecipeVariantProps
}
