...
export type FieldRecipeVariantProps = {
	[key in keyof FieldRecipeVariant]?:
		| ConditionalValue<FieldRecipeVariant[key]>
		| undefined;
};
...
export interface FieldRecipeRecipe {
	...
	splitVariantProps<Props extends FieldRecipeVariantProps>(
		props: Props,
	): [
		FieldRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof FieldRecipeVariantProps>>,
	];
