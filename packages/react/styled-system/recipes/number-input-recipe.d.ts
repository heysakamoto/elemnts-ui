...
export type NumberInputRecipeVariantProps = {
	[key in keyof NumberInputRecipeVariant]?:
		| ConditionalValue<NumberInputRecipeVariant[key]>
		| undefined;
};
...
export interface NumberInputRecipeRecipe {
	...
	(
		props?: NumberInputRecipeVariantProps,
	): Pretty<Record<NumberInputRecipeSlot, string>>;
	...
	splitVariantProps<Props extends NumberInputRecipeVariantProps>(
		props: Props,
	): [
		NumberInputRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof NumberInputRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: NumberInputRecipeVariantProps,
	) => NumberInputRecipeVariantProps;
