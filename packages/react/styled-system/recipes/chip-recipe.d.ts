...
export type ChipRecipeVariantProps = {
	[key in keyof ChipRecipeVariant]?:
		| ConditionalValue<ChipRecipeVariant[key]>
		| undefined;
};
...
export interface ChipRecipeRecipe {
	...
	splitVariantProps<Props extends ChipRecipeVariantProps>(
		props: Props,
	): [
		ChipRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof ChipRecipeVariantProps>>,
	];
