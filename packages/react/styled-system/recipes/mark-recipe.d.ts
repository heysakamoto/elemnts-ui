...
export type MarkRecipeVariantProps = {
  [key in keyof MarkRecipeVariant]?: ConditionalValue<MarkRecipeVariant[key]> | undefined
}
...
export interface MarkRecipeRecipe {
  ...
  splitVariantProps<Props extends MarkRecipeVariantProps>(props: Props): [MarkRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof MarkRecipeVariantProps>>]
