...
type DecorativeBoxRecipeVariantMap = {
	[key in keyof DecorativeBoxRecipeVariant]: Array<
		DecorativeBoxRecipeVariant[key]
	>;
};

export type DecorativeBoxRecipeVariantProps = {
	[key in keyof DecorativeBoxRecipeVariant]?:
		| ConditionalValue<DecorativeBoxRecipeVariant[key]>
		| undefined;
};
...
export interface DecorativeBoxRecipeRecipe {
	...
	raw: (
		props?: DecorativeBoxRecipeVariantProps,
	) => DecorativeBoxRecipeVariantProps;
	variantMap: DecorativeBoxRecipeVariantMap;
	variantKeys: Array<keyof DecorativeBoxRecipeVariant>;
	splitVariantProps<Props extends DecorativeBoxRecipeVariantProps>(
		props: Props,
	): [
		DecorativeBoxRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof DecorativeBoxRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: DecorativeBoxRecipeVariantProps,
	) => DecorativeBoxRecipeVariantProps;
