...
export type FieldsetRecipeVariantProps = {
	[key in keyof FieldsetRecipeVariant]?:
		| ConditionalValue<FieldsetRecipeVariant[key]>
		| undefined;
};
...
export interface FieldsetRecipeRecipe {
	...
	(
		props?: FieldsetRecipeVariantProps,
	): Pretty<Record<FieldsetRecipeSlot, string>>;
	...
	splitVariantProps<Props extends FieldsetRecipeVariantProps>(
		props: Props,
	): [
		FieldsetRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof FieldsetRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: FieldsetRecipeVariantProps,
	) => FieldsetRecipeVariantProps;
