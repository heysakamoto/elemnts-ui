...
export type ScrollAreaRecipeVariantProps = {
	[key in keyof ScrollAreaRecipeVariant]?:
		| ConditionalValue<ScrollAreaRecipeVariant[key]>
		| undefined;
};
...
export interface ScrollAreaRecipeRecipe {
	...
	(
		props?: ScrollAreaRecipeVariantProps,
	): Pretty<Record<ScrollAreaRecipeSlot, string>>;
	...
	splitVariantProps<Props extends ScrollAreaRecipeVariantProps>(
		props: Props,
	): [
		ScrollAreaRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof ScrollAreaRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: ScrollAreaRecipeVariantProps,
	) => ScrollAreaRecipeVariantProps;
