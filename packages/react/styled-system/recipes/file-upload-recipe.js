...
const fileUploadRecipeSlotNames = [
	...
	["itemDeleteTrigger", "file-upload__itemDeleteTrigger"],
	["itemGroup", "file-upload__itemGroup"],
	["itemName", "file-upload__itemName"],
	["itemPreview", "file-upload__itemPreview"],
	["itemPreviewImage", "file-upload__itemPreviewImage"],
	["itemSizeText", "file-upload__itemSizeText"],
	["label", "file-upload__label"],
	["clearTrigger", "file-upload__clearTrigger"],
];
const fileUploadRecipeSlotFns = /* @__PURE__ */ fileUploadRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			fileUploadRecipeDefaultVariants,
			getSlotCompoundVariant(fileUploadRecipeCompoundVariants, slotName),
		),
	],
);
...
const fileUploadRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		fileUploadRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
export const fileUploadRecipe = /* @__PURE__ */ Object.assign(
	fileUploadRecipeFn,
	{
		__recipe__: false,
