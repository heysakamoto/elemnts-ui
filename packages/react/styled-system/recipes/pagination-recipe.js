...
const paginationRecipeSlotNames = [
	...
	["firstTrigger", "pagination__firstTrigger"],
	["lastTrigger", "pagination__lastTrigger"],
];
const paginationRecipeSlotFns = /* @__PURE__ */ paginationRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			paginationRecipeDefaultVariants,
			getSlotCompoundVariant(paginationRecipeCompoundVariants, slotName),
		),
	],
);
...
const paginationRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		paginationRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
export const paginationRecipe = /* @__PURE__ */ Object.assign(
	paginationRecipeFn,
	{
		__recipe__: false,
