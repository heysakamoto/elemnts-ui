...
const comboboxRecipeSlotNames = [
	...
	["indicatorGroup", "combobox__indicatorGroup"],
];
const comboboxRecipeSlotFns = /* @__PURE__ */ comboboxRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			comboboxRecipeDefaultVariants,
			getSlotCompoundVariant(comboboxRecipeCompoundVariants, slotName),
		),
	],
);
...
const comboboxRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		comboboxRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
