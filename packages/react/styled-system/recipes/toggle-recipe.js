...
const toggleRecipeSlotFns = /* @__PURE__ */ toggleRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			toggleRecipeDefaultVariants,
			getSlotCompoundVariant(toggleRecipeCompoundVariants, slotName),
		),
	],
);
...
const toggleRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		toggleRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
