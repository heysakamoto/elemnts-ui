...
export type HighlightRecipeVariantProps = {
	[key in keyof HighlightRecipeVariant]?:
		| ConditionalValue<HighlightRecipeVariant[key]>
		| undefined;
};
...
export interface HighlightRecipeRecipe {
	...
	splitVariantProps<Props extends HighlightRecipeVariantProps>(
		props: Props,
	): [
		HighlightRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof HighlightRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: HighlightRecipeVariantProps,
	) => HighlightRecipeVariantProps;
}
