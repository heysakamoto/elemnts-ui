...
export type TimelineRecipeVariantProps = {
	[key in keyof TimelineRecipeVariant]?:
		| ConditionalValue<TimelineRecipeVariant[key]>
		| undefined;
};
...
export interface TimelineRecipeRecipe {
	...
	(
		props?: TimelineRecipeVariantProps,
	): Pretty<Record<TimelineRecipeSlot, string>>;
	...
	splitVariantProps<Props extends TimelineRecipeVariantProps>(
		props: Props,
	): [
		TimelineRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof TimelineRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: TimelineRecipeVariantProps,
	) => TimelineRecipeVariantProps;
