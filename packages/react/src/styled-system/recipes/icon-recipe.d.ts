...
export type IconRecipeVariantProps = {
	[key in keyof IconRecipeVariant]?:
		| ConditionalValue<IconRecipeVariant[key]>
		| undefined;
};
...
export interface IconRecipeRecipe {
	...
	splitVariantProps<Props extends IconRecipeVariantProps>(
		props: Props,
	): [
		IconRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof IconRecipeVariantProps>>,
	];
