...
export type TreeViewRecipeVariantProps = {
	[key in keyof TreeViewRecipeVariant]?:
		| ConditionalValue<TreeViewRecipeVariant[key]>
		| undefined;
};
...
export interface TreeViewRecipeRecipe {
	...
	(
		props?: TreeViewRecipeVariantProps,
	): Pretty<Record<TreeViewRecipeSlot, string>>;
	...
	splitVariantProps<Props extends TreeViewRecipeVariantProps>(
		props: Props,
	): [
		TreeViewRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof TreeViewRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: TreeViewRecipeVariantProps,
	) => TreeViewRecipeVariantProps;
