...
interface AspectRatioRecipeVariant {
...
export type AspectRatioRecipeVariantProps = {
  [key in keyof AspectRatioRecipeVariant]?: ConditionalValue<AspectRatioRecipeVariant[key]> | undefined
}
...
export interface AspectRatioRecipeRecipe {
  ...
  splitVariantProps<Props extends AspectRatioRecipeVariantProps>(props: Props): [AspectRatioRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof AspectRatioRecipeVariantProps>>]
  getVariantProps: (props?: AspectRatioRecipeVariantProps) => AspectRatioRecipeVariantProps
}
