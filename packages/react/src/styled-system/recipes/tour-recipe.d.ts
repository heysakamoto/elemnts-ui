...
type TourRecipeSlot = "root" | "positioner" | "content" | "title" | "description" | "actionTrigger" | "closeTrigger" | "arrow" | "arrowTip" | "control" | "backdrop" | "progressText" | "spotlight"

export type TourRecipeVariantProps = {
  [key in keyof TourRecipeVariant]?: ConditionalValue<TourRecipeVariant[key]> | undefined
}
...
export interface TourRecipeRecipe {
  ...
  splitVariantProps<Props extends TourRecipeVariantProps>(props: Props): [TourRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof TourRecipeVariantProps>>]
