...
const breadcrumbRecipeSlotNames = [
	["root", "breadcrumb__root"],
	["list", "breadcrumb__list"],
	["item", "breadcrumb__item"],
	["link", "breadcrumb__link"],
	["currentLink", "breadcrumb__currentLink"],
	["separator", "breadcrumb__separator"],
	["ellipsis", "breadcrumb__ellipsis"],
];
const breadcrumbRecipeSlotFns = /* @__PURE__ */ breadcrumbRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			breadcrumbRecipeDefaultVariants,
			getSlotCompoundVariant(breadcrumbRecipeCompoundVariants, slotName),
		),
	],
);
...
const breadcrumbRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		breadcrumbRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
export const breadcrumbRecipe = /* @__PURE__ */ Object.assign(
	breadcrumbRecipeFn,
	{
		__recipe__: false,
