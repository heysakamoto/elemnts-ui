...
type TileRecipeSlot = "root" | "content" | "control" | "addon" | "title" | "description" | "indicator"

export type TileRecipeVariantProps = {
  [key in keyof TileRecipeVariant]?: ConditionalValue<TileRecipeVariant[key]> | undefined
}
...
export interface TileRecipeRecipe {
  ...
  splitVariantProps<Props extends TileRecipeVariantProps>(props: Props): [TileRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof TileRecipeVariantProps>>]
