...
export type SeparatorRecipeVariantProps = {
  [key in keyof SeparatorRecipeVariant]?: ConditionalValue<SeparatorRecipeVariant[key]> | undefined
}
...
export interface SeparatorRecipeRecipe {
  ...
  splitVariantProps<Props extends SeparatorRecipeVariantProps>(props: Props): [SeparatorRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof SeparatorRecipeVariantProps>>]
  getVariantProps: (props?: SeparatorRecipeVariantProps) => SeparatorRecipeVariantProps
}
