...
type StatRecipeSlot = "root" | "label" | "valueText" | "helpText" | "valueUnit" | "indicator"

export type StatRecipeVariantProps = {
  [key in keyof StatRecipeVariant]?: ConditionalValue<StatRecipeVariant[key]> | undefined
}
...
export interface StatRecipeRecipe {
  ...
  splitVariantProps<Props extends StatRecipeVariantProps>(props: Props): [StatRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof StatRecipeVariantProps>>]
