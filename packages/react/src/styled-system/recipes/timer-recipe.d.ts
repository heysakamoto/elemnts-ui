...
export type TimerRecipeVariantProps = {
	[key in keyof TimerRecipeVariant]?:
		| ConditionalValue<TimerRecipeVariant[key]>
		| undefined;
};
...
export interface TimerRecipeRecipe {
	...
	splitVariantProps<Props extends TimerRecipeVariantProps>(
		props: Props,
	): [
		TimerRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof TimerRecipeVariantProps>>,
	];
