...
export type MenuRecipeVariantProps = {
	[key in keyof MenuRecipeVariant]?:
		| ConditionalValue<MenuRecipeVariant[key]>
		| undefined;
};
...
export interface MenuRecipeRecipe {
	...
	splitVariantProps<Props extends MenuRecipeVariantProps>(
		props: Props,
	): [
		MenuRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof MenuRecipeVariantProps>>,
	];
