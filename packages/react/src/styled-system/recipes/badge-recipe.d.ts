...
export type BadgeRecipeVariantProps = {
	[key in keyof BadgeRecipeVariant]?:
		| ConditionalValue<BadgeRecipeVariant[key]>
		| undefined;
};
...
export interface BadgeRecipeRecipe {
	...
	splitVariantProps<Props extends BadgeRecipeVariantProps>(
		props: Props,
	): [
		BadgeRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof BadgeRecipeVariantProps>>,
	];
