...
export type StepsRecipeVariantProps = {
	[key in keyof StepsRecipeVariant]?:
		| ConditionalValue<StepsRecipeVariant[key]>
		| undefined;
};
...
export interface StepsRecipeRecipe {
	...
	splitVariantProps<Props extends StepsRecipeVariantProps>(
		props: Props,
	): [
		StepsRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof StepsRecipeVariantProps>>,
	];
