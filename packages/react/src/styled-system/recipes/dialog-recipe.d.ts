...
type DialogRecipeSlot = "content" | "trigger" | "title" | "description" | "backdrop" | "positioner" | "closeTrigger"

export type DialogRecipeVariantProps = {
  [key in keyof DialogRecipeVariant]?: ConditionalValue<DialogRecipeVariant[key]> | undefined
}
...
export interface DialogRecipeRecipe {
  ...
  splitVariantProps<Props extends DialogRecipeVariantProps>(props: Props): [DialogRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof DialogRecipeVariantProps>>]
  getVariantProps: (props?: DialogRecipeVariantProps) => DialogRecipeVariantProps
}
