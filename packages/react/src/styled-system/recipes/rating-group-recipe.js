...
const ratingGroupRecipeSlotNames = [
	...
	["itemIndicator", "rating-group__itemIndicator"],
];
const ratingGroupRecipeSlotFns = /* @__PURE__ */ ratingGroupRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			ratingGroupRecipeDefaultVariants,
			getSlotCompoundVariant(ratingGroupRecipeCompoundVariants, slotName),
		),
	],
);
...
const ratingGroupRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		ratingGroupRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
export const ratingGroupRecipe = /* @__PURE__ */ Object.assign(
	ratingGroupRecipeFn,
	{
		__recipe__: false,
