...
const inputGroupRecipeFn = memo((props = {}) => {
  return Object.fromEntries(inputGroupRecipeSlotFns.map(([slotName, slotFn]) => [slotName, slotFn.recipeFn(props)]))
})
...
const getVariantProps = (variants) => ({ ...inputGroupRecipeDefaultVariants, ...compact(variants) })
