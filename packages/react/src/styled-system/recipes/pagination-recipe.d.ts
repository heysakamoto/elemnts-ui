...
export type PaginationRecipeVariantProps = {
	[key in keyof PaginationRecipeVariant]?:
		| ConditionalValue<PaginationRecipeVariant[key]>
		| undefined;
};
...
export interface PaginationRecipeRecipe {
	...
	(
		props?: PaginationRecipeVariantProps,
	): Pretty<Record<PaginationRecipeSlot, string>>;
	...
	splitVariantProps<Props extends PaginationRecipeVariantProps>(
		props: Props,
	): [
		PaginationRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof PaginationRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: PaginationRecipeVariantProps,
	) => PaginationRecipeVariantProps;
