...
export interface GroupRecipeRecipe {
  ...
  splitVariantProps<Props extends GroupRecipeVariantProps>(props: Props): [GroupRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof GroupRecipeVariantProps>>]
