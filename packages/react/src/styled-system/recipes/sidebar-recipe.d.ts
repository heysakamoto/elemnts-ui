...
export type SidebarRecipeVariantProps = {
	[key in keyof SidebarRecipeVariant]?:
		| ConditionalValue<SidebarRecipeVariant[key]>
		| undefined;
};
...
export interface SidebarRecipeRecipe {
	...
	(
		props?: SidebarRecipeVariantProps,
	): Pretty<Record<SidebarRecipeSlot, string>>;
	...
	splitVariantProps<Props extends SidebarRecipeVariantProps>(
		props: Props,
	): [
		SidebarRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof SidebarRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: SidebarRecipeVariantProps,
	) => SidebarRecipeVariantProps;
