...
interface SkipNavRecipeVariant {
...
export type SkipNavRecipeVariantProps = {
  [key in keyof SkipNavRecipeVariant]?: ConditionalValue<SkipNavRecipeVariant[key]> | undefined
}

export interface SkipNavRecipeRecipe {
  __slot: SkipNavRecipeSlot
  __type: SkipNavRecipeVariantProps
  (props?: SkipNavRecipeVariantProps): Pretty<Record<SkipNavRecipeSlot, string>>
  ...
  splitVariantProps<Props extends SkipNavRecipeVariantProps>(props: Props): [SkipNavRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof SkipNavRecipeVariantProps>>]
  getVariantProps: (props?: SkipNavRecipeVariantProps) => SkipNavRecipeVariantProps
}
