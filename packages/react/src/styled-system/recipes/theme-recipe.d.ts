...
export type ThemeRecipeVariantProps = {
	[key in keyof ThemeRecipeVariant]?:
		| ConditionalValue<ThemeRecipeVariant[key]>
		| undefined;
};
...
export interface ThemeRecipeRecipe {
	...
	splitVariantProps<Props extends ThemeRecipeVariantProps>(
		props: Props,
	): [
		ThemeRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof ThemeRecipeVariantProps>>,
	];
