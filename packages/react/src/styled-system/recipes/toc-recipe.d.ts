...
export type TocRecipeVariantProps = {
	[key in keyof TocRecipeVariant]?:
		| ConditionalValue<TocRecipeVariant[key]>
		| undefined;
};
...
export interface TocRecipeRecipe {
	...
	splitVariantProps<Props extends TocRecipeVariantProps>(
		props: Props,
	): [
		TocRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof TocRecipeVariantProps>>,
	];
