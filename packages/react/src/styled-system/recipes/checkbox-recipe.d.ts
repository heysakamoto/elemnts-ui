...
export type CheckboxRecipeVariantProps = {
  [key in keyof CheckboxRecipeVariant]?: ConditionalValue<CheckboxRecipeVariant[key]> | undefined
}

export interface CheckboxRecipeRecipe {
  __slot: CheckboxRecipeSlot
  __type: CheckboxRecipeVariantProps
  (props?: CheckboxRecipeVariantProps): Pretty<Record<CheckboxRecipeSlot, string>>
  ...
  splitVariantProps<Props extends CheckboxRecipeVariantProps>(props: Props): [CheckboxRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof CheckboxRecipeVariantProps>>]
  getVariantProps: (props?: CheckboxRecipeVariantProps) => CheckboxRecipeVariantProps
}
