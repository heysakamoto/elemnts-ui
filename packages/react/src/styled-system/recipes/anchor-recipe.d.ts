...
export type AnchorRecipeVariantProps = {
	[key in keyof AnchorRecipeVariant]?:
		| ConditionalValue<AnchorRecipeVariant[key]>
		| undefined;
};
...
export interface AnchorRecipeRecipe {
	...
	splitVariantProps<Props extends AnchorRecipeVariantProps>(
		props: Props,
	): [
		AnchorRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof AnchorRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: AnchorRecipeVariantProps,
	) => AnchorRecipeVariantProps;
}
