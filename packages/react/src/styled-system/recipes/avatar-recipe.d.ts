...
export type AvatarRecipeVariantProps = {
	[key in keyof AvatarRecipeVariant]?:
		| ConditionalValue<AvatarRecipeVariant[key]>
		| undefined;
};
...
export interface AvatarRecipeRecipe {
	...
	splitVariantProps<Props extends AvatarRecipeVariantProps>(
		props: Props,
	): [
		AvatarRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof AvatarRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: AvatarRecipeVariantProps,
	) => AvatarRecipeVariantProps;
}
