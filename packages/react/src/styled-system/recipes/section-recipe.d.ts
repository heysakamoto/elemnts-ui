...
interface SectionRecipeVariant {
...
export type SectionRecipeVariantProps = {
  [key in keyof SectionRecipeVariant]?: ConditionalValue<SectionRecipeVariant[key]> | undefined
}
...
export interface SectionRecipeRecipe {
  ...
  splitVariantProps<Props extends SectionRecipeVariantProps>(props: Props): [SectionRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof SectionRecipeVariantProps>>]
  getVariantProps: (props?: SectionRecipeVariantProps) => SectionRecipeVariantProps
}
