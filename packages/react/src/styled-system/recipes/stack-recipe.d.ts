...
export type StackRecipeVariantProps = {
	[key in keyof StackRecipeVariant]?:
		| ConditionalValue<StackRecipeVariant[key]>
		| undefined;
};
...
export interface StackRecipeRecipe {
	...
	splitVariantProps<Props extends StackRecipeVariantProps>(
		props: Props,
	): [
		StackRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof StackRecipeVariantProps>>,
	];
