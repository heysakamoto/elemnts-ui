...
const skipNavRecipeSlotFns = /* @__PURE__ */ skipNavRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			skipNavRecipeDefaultVariants,
			getSlotCompoundVariant(skipNavRecipeCompoundVariants, slotName),
		),
	],
);
...
const skipNavRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		skipNavRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
