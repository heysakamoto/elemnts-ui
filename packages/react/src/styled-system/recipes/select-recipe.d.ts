...
export type SelectRecipeVariantProps = {
	[key in keyof SelectRecipeVariant]?:
		| ConditionalValue<SelectRecipeVariant[key]>
		| undefined;
};
...
export interface SelectRecipeRecipe {
	...
	splitVariantProps<Props extends SelectRecipeVariantProps>(
		props: Props,
	): [
		SelectRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof SelectRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: SelectRecipeVariantProps,
	) => SelectRecipeVariantProps;
}
