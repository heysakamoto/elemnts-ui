...
const numberInputRecipeSlotNames = [
	...
	["valueText", "number-input__valueText"],
...
const numberInputRecipeSlotFns = /* @__PURE__ */ numberInputRecipeSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			numberInputRecipeDefaultVariants,
			getSlotCompoundVariant(numberInputRecipeCompoundVariants, slotName),
		),
	],
);
...
const numberInputRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		numberInputRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
export const numberInputRecipe = /* @__PURE__ */ Object.assign(
	numberInputRecipeFn,
	{
		__recipe__: false,
