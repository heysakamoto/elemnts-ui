...
export type BoxRecipeVariantProps = {
	[key in keyof BoxRecipeVariant]?:
		| ConditionalValue<BoxRecipeVariant[key]>
		| undefined;
};
...
export interface BoxRecipeRecipe {
	...
	splitVariantProps<Props extends BoxRecipeVariantProps>(
		props: Props,
	): [
		BoxRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof BoxRecipeVariantProps>>,
	];
