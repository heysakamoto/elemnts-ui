...
export type DownloadRecipeVariantProps = {
	[key in keyof DownloadRecipeVariant]?:
		| ConditionalValue<DownloadRecipeVariant[key]>
		| undefined;
};
...
export interface DownloadRecipeRecipe {
	...
	splitVariantProps<Props extends DownloadRecipeVariantProps>(
		props: Props,
	): [
		DownloadRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof DownloadRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: DownloadRecipeVariantProps,
	) => DownloadRecipeVariantProps;
}
