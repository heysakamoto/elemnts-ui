...
export type TooltipRecipeVariantProps = {
	[key in keyof TooltipRecipeVariant]?:
		| ConditionalValue<TooltipRecipeVariant[key]>
		| undefined;
};
...
export interface TooltipRecipeRecipe {
	...
	(
		props?: TooltipRecipeVariantProps,
	): Pretty<Record<TooltipRecipeSlot, string>>;
	...
	splitVariantProps<Props extends TooltipRecipeVariantProps>(
		props: Props,
	): [
		TooltipRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof TooltipRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: TooltipRecipeVariantProps,
	) => TooltipRecipeVariantProps;
