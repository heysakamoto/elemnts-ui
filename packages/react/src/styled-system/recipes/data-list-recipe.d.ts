...
export type DataListRecipeVariantProps = {
  [key in keyof DataListRecipeVariant]?: ConditionalValue<DataListRecipeVariant[key]> | undefined
}

export interface DataListRecipeRecipe {
  __slot: DataListRecipeSlot
  __type: DataListRecipeVariantProps
  (props?: DataListRecipeVariantProps): Pretty<Record<DataListRecipeSlot, string>>
  ...
  splitVariantProps<Props extends DataListRecipeVariantProps>(props: Props): [DataListRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof DataListRecipeVariantProps>>]
  getVariantProps: (props?: DataListRecipeVariantProps) => DataListRecipeVariantProps
}
