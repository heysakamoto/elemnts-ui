...
export type SurfaceRecipeVariantProps = {
	[key in keyof SurfaceRecipeVariant]?:
		| ConditionalValue<SurfaceRecipeVariant[key]>
		| undefined;
};
...
export interface SurfaceRecipeRecipe {
	...
	(
		props?: SurfaceRecipeVariantProps,
	): Pretty<Record<SurfaceRecipeSlot, string>>;
	...
	splitVariantProps<Props extends SurfaceRecipeVariantProps>(
		props: Props,
	): [
		SurfaceRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof SurfaceRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: SurfaceRecipeVariantProps,
	) => SurfaceRecipeVariantProps;
