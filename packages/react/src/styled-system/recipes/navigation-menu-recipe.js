...
const navigationMenuRecipeSlotNames = [
	...
	["itemIndicator", "navigation-menu__itemIndicator"],
	["viewport", "navigation-menu__viewport"],
	["viewportPositioner", "navigation-menu__viewportPositioner"],
	["content", "navigation-menu__content"],
];
const navigationMenuRecipeSlotFns =
	/* @__PURE__ */ navigationMenuRecipeSlotNames.map(([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			navigationMenuRecipeDefaultVariants,
			getSlotCompoundVariant(navigationMenuRecipeCompoundVariants, slotName),
		),
	]);

const navigationMenuRecipeFn = memo((props = {}) => {
	return Object.fromEntries(
		navigationMenuRecipeSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
export const navigationMenuRecipe = /* @__PURE__ */ Object.assign(
	navigationMenuRecipeFn,
	{
		__recipe__: false,
