...
export type ColorThemeRecipeVariantProps = {
	[key in keyof ColorThemeRecipeVariant]?:
		| ConditionalValue<ColorThemeRecipeVariant[key]>
		| undefined;
};
...
export interface ColorThemeRecipeRecipe {
	...
	(
		props?: ColorThemeRecipeVariantProps,
	): Pretty<Record<ColorThemeRecipeSlot, string>>;
	...
	splitVariantProps<Props extends ColorThemeRecipeVariantProps>(
		props: Props,
	): [
		ColorThemeRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof ColorThemeRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: ColorThemeRecipeVariantProps,
	) => ColorThemeRecipeVariantProps;
