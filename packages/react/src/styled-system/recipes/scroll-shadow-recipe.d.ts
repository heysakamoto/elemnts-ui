...
type ScrollShadowRecipeVariantMap = {
	[key in keyof ScrollShadowRecipeVariant]: Array<
		ScrollShadowRecipeVariant[key]
	>;
};

export type ScrollShadowRecipeVariantProps = {
	[key in keyof ScrollShadowRecipeVariant]?:
		| ConditionalValue<ScrollShadowRecipeVariant[key]>
		| undefined;
};
...
export interface ScrollShadowRecipeRecipe {
	...
	raw: (
		props?: ScrollShadowRecipeVariantProps,
	) => ScrollShadowRecipeVariantProps;
	variantMap: ScrollShadowRecipeVariantMap;
	variantKeys: Array<keyof ScrollShadowRecipeVariant>;
	splitVariantProps<Props extends ScrollShadowRecipeVariantProps>(
		props: Props,
	): [
		ScrollShadowRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof ScrollShadowRecipeVariantProps>>,
	];
	getVariantProps: (
		props?: ScrollShadowRecipeVariantProps,
	) => ScrollShadowRecipeVariantProps;
