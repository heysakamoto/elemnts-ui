...
export type ElevatedRecipeVariantProps = {
  [key in keyof ElevatedRecipeVariant]?: ConditionalValue<ElevatedRecipeVariant[key]> | undefined
}
...
export interface ElevatedRecipeRecipe {
  ...
  splitVariantProps<Props extends ElevatedRecipeVariantProps>(props: Props): [ElevatedRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof ElevatedRecipeVariantProps>>]
  getVariantProps: (props?: ElevatedRecipeVariantProps) => ElevatedRecipeVariantProps
}
