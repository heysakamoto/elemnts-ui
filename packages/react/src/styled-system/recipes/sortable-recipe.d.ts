...
interface SortableRecipeVariant {
...
export type SortableRecipeVariantProps = {
  [key in keyof SortableRecipeVariant]?: ConditionalValue<SortableRecipeVariant[key]> | undefined
}

export interface SortableRecipeRecipe {
  __slot: SortableRecipeSlot
  __type: SortableRecipeVariantProps
  (props?: SortableRecipeVariantProps): Pretty<Record<SortableRecipeSlot, string>>
  ...
  splitVariantProps<Props extends SortableRecipeVariantProps>(props: Props): [SortableRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof SortableRecipeVariantProps>>]
  getVariantProps: (props?: SortableRecipeVariantProps) => SortableRecipeVariantProps
}
