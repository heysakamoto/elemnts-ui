...
type AlertRecipeSlot = "root" | "content" | "title" | "description" | "indicator" | "control"

export type AlertRecipeVariantProps = {
  [key in keyof AlertRecipeVariant]?: ConditionalValue<AlertRecipeVariant[key]> | undefined
}
...
export interface AlertRecipeRecipe {
  ...
  splitVariantProps<Props extends AlertRecipeVariantProps>(props: Props): [AlertRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof AlertRecipeVariantProps>>]
