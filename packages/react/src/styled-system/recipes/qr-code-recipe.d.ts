...
type QrCodeRecipeSlot = "root" | "overlay" | "frame" | "pattern" | "downloadTrigger"

export type QrCodeRecipeVariantProps = {
  [key in keyof QrCodeRecipeVariant]?: ConditionalValue<QrCodeRecipeVariant[key]> | undefined
}
...
export interface QrCodeRecipeRecipe {
  ...
  splitVariantProps<Props extends QrCodeRecipeVariantProps>(props: Props): [QrCodeRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof QrCodeRecipeVariantProps>>]
  getVariantProps: (props?: QrCodeRecipeVariantProps) => QrCodeRecipeVariantProps
}
