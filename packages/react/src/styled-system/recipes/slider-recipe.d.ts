...
type SliderRecipeSlot = "root" | "control" | "label" | "step" | "marker" | "range" | "thumb" | "valueText" | "track" | "markerGroup" | "stepGroup"

export type SliderRecipeVariantProps = {
  [key in keyof SliderRecipeVariant]?: ConditionalValue<SliderRecipeVariant[key]> | undefined
}
...
export interface SliderRecipeRecipe {
  ...
  splitVariantProps<Props extends SliderRecipeVariantProps>(props: Props): [SliderRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof SliderRecipeVariantProps>>]
  getVariantProps: (props?: SliderRecipeVariantProps) => SliderRecipeVariantProps
}
