...
export type ContainerRecipeVariantProps = {
  [key in keyof ContainerRecipeVariant]?: ConditionalValue<ContainerRecipeVariant[key]> | undefined
}
...
export interface ContainerRecipeRecipe {
  ...
  splitVariantProps<Props extends ContainerRecipeVariantProps>(props: Props): [ContainerRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof ContainerRecipeVariantProps>>]
  getVariantProps: (props?: ContainerRecipeVariantProps) => ContainerRecipeVariantProps
}
