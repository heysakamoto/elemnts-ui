...
export type TagRecipeVariantProps = {
	[key in keyof TagRecipeVariant]?:
		| ConditionalValue<TagRecipeVariant[key]>
		| undefined;
};
...
export interface TagRecipeRecipe {
	...
	splitVariantProps<Props extends TagRecipeVariantProps>(
		props: Props,
	): [
		TagRecipeVariantProps,
		Pretty<DistributiveOmit<Props, keyof TagRecipeVariantProps>>,
	];
