...
interface FocusTrapRecipeVariant {
...
export type FocusTrapRecipeVariantProps = {
  [key in keyof FocusTrapRecipeVariant]?: ConditionalValue<FocusTrapRecipeVariant[key]> | undefined
}
...
export interface FocusTrapRecipeRecipe {
  ...
  splitVariantProps<Props extends FocusTrapRecipeVariantProps>(props: Props): [FocusTrapRecipeVariantProps, Pretty<DistributiveOmit<Props, keyof FocusTrapRecipeVariantProps>>]
  getVariantProps: (props?: FocusTrapRecipeVariantProps) => FocusTrapRecipeVariantProps
}
