...
const items = [
  { value: "01-introduction", depth: 2, label: "Introduction" },
  {
    value: "01-getting-started",
    depth: 2,
    label: "Getting Started",
  },
  { value: "01-installation", depth: 2, label: "Installation" },
  { value: "01-usage", depth: 2, label: "Usage" },
  { value: "01-conclusion", depth: 2, label: "Conclusion" },
];
