...
export const shadows = defineSemanticTokens.shadows({
	...
	"2": {
		value: {
			base: "0 1px 1px -.5px #0000000f",
			_dark: "inset 0 1px 0 0 #ffffff03, 0 1px 1px -.5px #0000002e",
		},
	},
	"3": {
		value: {
			base: "0 1px 1px -.5px #0000000f, 0 3px 3px -1.5px #0000000f",
			_dark:
	...
	"4": {
		value: {
			base: "0 1px 1px -.5px #0000000f, 0 3px 3px -1.5px #0000000f, 0 6px 6px -3px #0000000f",
			_dark:
	...
	"5": {
		value: {
			base: "0 1px 1px -.5px #0000000f, 0 3px 3px -1.5px #0000000f, 0 6px 6px -3px #0000000f, 0 12px 12px -6px #0000000f",
			_dark:
	...
	"6": {
		value: {
			base: "0 1px 1px -.5px #0000000f, 0 3px 3px -1.5px #0000000f, 0 6px 6px -3px #0000000f, 0 12px 12px -6px #0000000f, 0 24px 24px -12px #0000000f",
			_dark:
	...
	"7": {
		value: {
			base: "0 1px 1px -.5px #0000000f, 0 3px 3px -1.5px #0000000f, 0 6px 6px -3px #0000000f, 0 12px 12px -6px #0000000f, 0 24px 24px -12px #0000000f, 0 48px 48px -24px #0000000f",
			_dark:
	...
	"8": {
		value: {
			base: "0 1px 1px -.5px #0000000f, 0 3px 3px -1.5px #0000000f, 0 6px 6px -3px #0000000f, 0 12px 12px -6px #0000000f, 0 24px 24px -12px #0000000f, 0 48px 48px -24px #0000000f, 0 96px 96px -48px #0000000f",
			_dark:
