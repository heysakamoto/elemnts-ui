...
export function LandingHero() {
    ...
    <Section pb="80" pt={["80", "96"]}>
      <Container px="16" maxW="40rem">
        ...
        <Text mt="12" color="fg.secondary" fontSize={{ base: "16", md: "18" }}>
        ...
        <ButtonGroup mt="20" size="lg">
          <ButtonGroup.Item asChild>
            <Link to="/docs/$">
              Go to docs
              <Icon width={20} height={20} icon="tabler:arrow-right" />
            </Link>
          </ButtonGroup.Item>
          <ButtonGroup.Item asChild variant="secondary">
            <Link to="/sponsor">Become a Sponsor</Link>
          </ButtonGroup.Item>
        </ButtonGroup>
      </Container>
      <Container px="16" maxW="40rem" mt={["48", "64"]}>
        <Grid
          gap="20"
