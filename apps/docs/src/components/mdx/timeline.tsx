import { Chip, Separator, Text, Timeline } from "@elemnts-ui/react";
import type { PropsWithChildren, ReactNode } from "react";

export function TimelineRoot(props: Timeline["Props"]) {
	return <Timeline mt="32" {...props} />;
}
		...
		<Timeline.Item>
			<Timeline.Connector>
				...
				<Timeline.Indicator asChild>
					<Chip iconOnly size="xs" variant="secondary">
						{index}
					</Chip>
				</Timeline.Indicator>
			</Timeline.Connector>
			<Timeline.Content gap="0">
				<Text as="strong" fontSize={[16, 18]}>
					{title}
				</Text>
				{children}
			</Timeline.Content>
