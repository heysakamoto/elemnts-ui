...
Elemnts UI components are built with flexibility in mind, giving you two powerful ways to customize how components render: the **as** prop and the **asChild** prop. Both are powered by [Ark UI](https://ark-ui.com/).
...
```tsx
import { factory } from "@elemnts-ui/react";
...
```tsx
import { styled, factory } from "@elemnts-ui/react";
